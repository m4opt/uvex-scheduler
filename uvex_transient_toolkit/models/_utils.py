"""
Numerical coercion and unit-conversion utilities for :mod:`uvex_transient_toolkit.models`.
...
from uvex_transient_toolkit.models._typing import FloatArray, FloatResult, PhysicalInput, UnitLike

# ------------------------------------------ #
# Internal Unit Conventions                  #
# ------------------------------------------ #
# To avoid explicit / lengthy units in the code, we define a set of standard units for
# outputs from the uvex_transient_toolkit.models library.
...
# into one another and are used heavily in the uvex_transient_toolkit.models module to coerce unit-bearing user
...
def model_class_from_kernel(
    ...
    evaluate
        ...
        one of a :class:`~uvex_transient_toolkit.models.core.SpectralModel` subclass's
