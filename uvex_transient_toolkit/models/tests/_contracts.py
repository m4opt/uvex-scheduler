"""
Shared, inheritable pytest "contracts" for :mod:`uvex_transient_toolkit.models`.

Rather than writing bespoke tests for every :class:`~uvex_transient_toolkit.models.core.Lightcurve`/
:class:`~uvex_transient_toolkit.models.core.Spectrum`/:class:`~uvex_transient_toolkit.models.core.SpectralModel`
...
consistency invariants described in :mod:`uvex_transient_toolkit.models.core._base` plus
...
from uvex_transient_toolkit.models._utils import AB_MAG_ZERO_POINT, to_cgs_value
...
def _integration_bounds(model_class, cgs_params: dict) -> tuple[float, float]:
    ...
    :attr:`~uvex_transient_toolkit.models.core._base.Spectrum._DOMAIN` (possibly infinite)
    otherwise.
    """
...
class ModelContract:
    ...
    :class:`~uvex_transient_toolkit.models.core._base.Lightcurve`,
    :class:`~uvex_transient_toolkit.models.core._base.Spectrum`, or
    :class:`~uvex_transient_toolkit.models.core._base.SpectralModel` subclass.
    """
...
class LightcurveContract(ModelContract):
    """Generic checks for :class:`~uvex_transient_toolkit.models.core._base.Lightcurve` subclasses."""
...
class SpectrumContract(ModelContract):
    """Generic checks for :class:`~uvex_transient_toolkit.models.core._base.Spectrum` subclasses."""
...
class SpectralModelContract(ModelContract):
    """
    Generic checks for :class:`~uvex_transient_toolkit.models.core._base.SpectralModel` subclasses.

    Covers both plain ``SpectralModel`` subclasses and
    :class:`~uvex_transient_toolkit.models.core._base.ComposedSpectralModel` subclasses --
