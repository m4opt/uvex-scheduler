r"""
Numerical helpers shared by the spectral shape models in :mod:`uvex_transient_toolkit.models.spectra`.
"""

import numpy as np
from astropy import constants as const

from uvex_transient_toolkit.models._typing import FloatArray, NumericalInput
...
def powerlaw_shape_integral_cgs(
    ...
    for :class:`~uvex_transient_toolkit.models.spectra.powerlaw.PowerLawSpectrum`'s own
    normalization and, applied twice with a shared reference frequency, for
    :class:`~uvex_transient_toolkit.models.spectra.powerlaw.BrokenPowerLawSpectrum`'s two
    segments.
