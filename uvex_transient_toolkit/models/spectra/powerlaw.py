...
overrides :meth:`~uvex_transient_toolkit.models.core._base.Spectrum._eval_normalization`
with the closed-form integral of its own shape (see
:func:`~uvex_transient_toolkit.models.spectra._utils.powerlaw_shape_integral_cgs`).
"""
...
from uvex_transient_toolkit.models.core.priors import ConstantPrior, NormalPrior
