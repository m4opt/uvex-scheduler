...
from uvex_transient_toolkit.models.core.priors import LogNormalPrior
...
class BlackbodySpectrum(Spectrum):
    ...
    :class:`~uvex_transient_toolkit.models.core.priors.LogNormalPrior`, a physically motivated
    prior for a strictly positive scale parameter; like any other
    :class:`~uvex_transient_toolkit.models.core._parameters.Parameter`, it can be overridden
    per instance.
