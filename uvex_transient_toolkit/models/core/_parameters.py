...
from uvex_transient_toolkit.models._typing import (
    FloatArray,
    PhysicalInput,
    RNGInput,
    ScalarPhysicalValue,
)
from uvex_transient_toolkit.models._utils import ensure_numpy_array
from uvex_transient_toolkit.models.core.priors import Prior
...
class Parameter:
    ...
    :class:`~uvex_transient_toolkit.models.core.priors.Prior` to sample from, a
    ...
    :class:`~uvex_transient_toolkit.models.core.priors.NormalPrior` via ``transform="log"``,
    ...
    # -------------------------------------- #
    prior: Prior
    """~uvex_transient_toolkit.models.core.priors.Prior: The prior distribution for the latent variable :math:`z`."""
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.prior, Prior):
            raise TypeError(
                "Parameter 'prior' must be an instance of uvex_transient_toolkit.models.core.priors.Prior, "
    ...
    def set_prior(self, prior: Prior) -> None:
        ...
        Parameters
        ----------
        prior : uvex_transient_toolkit.models.core.priors.Prior
